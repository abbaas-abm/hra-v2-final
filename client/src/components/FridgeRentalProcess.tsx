...
const FridgeRentalProcess = () => {
    ...
    const steps = [
        {
            title: "Choose your fridge from the options above",
            description: "Find the perfect size and style to match your needs and budget."
        },
        {
            title: "Submit your documents and make your deposit",
            description: "Simple paperwork and a quick deposit to secure your rental."
        },
        {
            title: "We deliver to your door fast and friendly",
            description: "Prompt delivery right where you need it, with care and a smile."
        },
        {
            title: "Enjoy the convenience of a cold drink any time!",
            description: "Reliable cooling at your fingertips, stress-free and hassle-free."
        }
    ];
...
export default FridgeRentalProcess;
